const slider = document.querySelector('[data="slider"]') as HTMLDivElement
const sliderItens = slider.querySelectorAll('[data="secReviews__card"]') as NodeListOf<HTMLDivElement>
const sliderbuttons = slider.querySelectorAll('[data="sliderBnts"]') as NodeListOf<HTMLButtonElement>

const sliderPoits : number[] = [0, 1, 2] 
...
const sliderNext = () => {
    if(sliderItens.length < 2) return
